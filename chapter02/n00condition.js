 ...
 * 
 * 그 값이 위에 해당하는지에 따라 case에 입력 가능
 * 
 * case "도" -> 가능
 * case 1 -? 가능
 * 
 * defualt의 경우에는 아무런 case에 해당되지 않을 때 실행.
 * 
 * break;의 의미도 중요합니다.
 * 
 * : switch문에서 case는 순서대로 실행되면서 검증합니다. 그러므로 break;가 없다면 그 다음 case까지 실행이 된다는 점에 유의할 필요가 있습니다.
 * 
 * chapter03
 * n00loops.js
 * index.html
